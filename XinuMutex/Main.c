...
process producer(sid32 produced, sid32 consumed,sid32 mutex)
{
	/* */
	int32 n=0;
...
process consumer(sid32 produced, sid32 consumed,sid32 mutex)
{
...
process	main(void)
{
	...
	producer_id = create(producer, 4096, 50, "producer", 3,produced,consumed,mutex);
	consumer_id = create(consumer, 4096, 50, "consumer", 3,produced,consumed,mutex);
